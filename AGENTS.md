...
**CRITICAL**: You have been given read/write access to base the directory for go including GOCACHE, GOMODCACHE, GOTMPDIR you do not need to use /tmp for go toolchain writes
