...
Configurations are provided as YAML files and can be expressed as one or more
...
https://developer.konghq.com/api/konnect/application-auth-strategies/v2/#/operations/create-app-auth-strategy
...
https://developer.konghq.com/api/konnect/service-catalog/v1/#/operations/create-catalog-service
...
https://developer.konghq.com/api/konnect/control-planes/v2/#/operations/create-control-plane
...
https://developer.konghq.com/api/konnect/api-builder/v3/#/operations/create-api
...
https://developer.konghq.com/api/konnect/portal-management/v3/#/operations/create-portal
...
https://developer.konghq.com/api/konnect/event-gateway/v1/#/operations/create-event-gateway
