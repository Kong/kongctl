...
func (a *APIImplementationAdapter) MapCreateFields(_ context.Context, _ map[string]interface{},
...
func (a *APIImplementationAdapter) MapUpdateFields(_ context.Context, _ map[string]interface{},
