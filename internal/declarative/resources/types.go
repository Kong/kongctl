...
type ResourceSet struct {
	...
	PortalAssetLogos     []PortalAssetLogoResource     `yaml:"portal_assets_logos,omitempty"         json:"portal_assets_logos,omitempty"`    //nolint:lll
	PortalAssetFavicons  []PortalAssetFaviconResource  `yaml:"portal_assets_favicons,omitempty"      json:"portal_assets_favicons,omitempty"` //nolint:lll
