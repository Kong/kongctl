...
type ResourceSet struct {
	...
	PortalAssetLogos     []PortalAssetLogoResource     `yaml:"portal_assets_logo,omitempty"          json:"portal_assets_logo,omitempty"`    //nolint:lll
	PortalAssetFavicons  []PortalAssetFaviconResource  `yaml:"portal_assets_favicon,omitempty"       json:"portal_assets_favicon,omitempty"` //nolint:lll
