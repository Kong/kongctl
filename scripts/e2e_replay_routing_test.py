...
class RoutingTest(unittest.TestCase):
    ...
    def test_main_is_all_live_and_pr_is_an_exact_partition(self):
        ...
        self.assertIn("event-gateway/consume-policy/scenario.yaml", pr["replay"])
        ...
        self.assertIn("portal/ip-allow-list/scenario.yaml", pr["replay"])
        self.assertIn("portal/pages/scenario.yaml", pr["replay"])
        ...
        self.assertIn("dump/portal-owned/scenario.yaml", pr["replay"])
        self.assertEqual(20, len(pr["replay"]))
