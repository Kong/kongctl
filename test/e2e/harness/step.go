...
var createResourceEndpoints = map[string]resourceEndpoint{
	...
	"directory":          {Method: http.MethodPost, Path: "/v2/directories"},
	"directories":        {Method: http.MethodPost, Path: "/v2/directories"},
	"identity_directory": {Method: http.MethodPost, Path: "/v2/directories"},
